...
export default function ProfilePage() {
  ...
  const [userInfo, setUserInfo] = useState({
    ...
    department: "3rd Year Medicine Student",
    studentId: "2104002001"
  });
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionLabel}>Personal Informations</Text>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionLabel}>ACADEMIC INFORMATIONS</Text>
        ...
        <View style={styles.section}>
          ...
          <Pressable style={[styles.actionRow, { borderBottomWidth: 0 }]}>
            <View style={styles.actionLeft}>
              ...
              <Text style={[styles.actionText, { color: Colors.danger }]}>Reset Database</Text>
            </View>
          </Pressable>
        </View>
